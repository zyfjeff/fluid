...
func (j *CacheFSEngine) queryCacheStatus() (states cacheStates, err error) {
	...
	err = j.getCacheRatio(&states)
	return
}

// get cacheHitRatio & cacheThroughputRatio from fuse pod
func (j *CacheFSEngine) getCacheRatio(states *cacheStates) (err error) {
