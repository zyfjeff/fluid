...
func (j *CacheFSEngine) setupMasterInternal() (err error) {
	...
	valuefileName, err := j.generateCacheFSValueFile(runtime)
	if err != nil {
		return
	}
...
func (j *CacheFSEngine) generateCacheFSValueFile(runtime *datav1alpha1.CacheFSRuntime) (valueFileName string, err error) {
...
func (j *CacheFSEngine) getConfigmapName() string {
