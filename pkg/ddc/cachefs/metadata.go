...
func (j *CacheFSEngine) SyncMetadata() (err error) {
...
func (j *CacheFSEngine) shouldSyncMetadata() (should bool, err error) {
...
func (j *CacheFSEngine) syncMetadataInternal() (err error) {
